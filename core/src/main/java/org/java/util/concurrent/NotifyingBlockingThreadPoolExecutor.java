/*
 * Adapted from https://today.java.net/pub/a/today/2008/10/23/creating-a-notifying-blocking-thread-pool-executor.html
 * 
 * Changes:
 * + Addition of threadFactory (to support custom naming of threads in the pool)
 */
...
public class NotifyingBlockingThreadPoolExecutor extends ThreadPoolExecutor {
     ...
     * @param threadFactory        is the thread factory to use to create threads in the pool. null=use default factory (added by pmonks@gmail.com)
	 ...
	 */
	public NotifyingBlockingThreadPoolExecutor(int poolSize, int queueSize, long keepAliveTime, TimeUnit keepAliveTimeUnit, ThreadFactory threadFactory, long maxBlockingTime, TimeUnit maxBlockingTimeUnit, Callable<Boolean> blockingTimeCallback) {
	 ...
	 * @param threadFactory     is the thread factory to use to create threads in the pool. null=use default factory (added by pmonks@gmail.com)
	 */
	public NotifyingBlockingThreadPoolExecutor(int poolSize, int queueSize, long keepAliveTime, TimeUnit keepAliveTimeUnit, ThreadFactory threadFactory) {
